    ...
    while (true) {
        ...
        case std::to_underlying(ModbusRegisters::SystemHoldingRegister::fan1_pwm): {
            if (msg->m_Value == std::numeric_limits<uint16_t>::max()) {
                ...
                if (Fans::heat_break(PhysicalToolIndex::from_raw(0)).is_selftest()) {
                ...
                if (!Fans::heat_break(PhysicalToolIndex::from_raw(0)).is_selftest()) {
                    ...
                    Fans::heat_break(PhysicalToolIndex::from_raw(0)).enter_selftest_mode();
                }

                log_info(ModbusControl, "Set heatbreak fan PWM:: %" PRIu32, msg->m_Value);
                Fans::heat_break(PhysicalToolIndex::from_raw(0)).selftest_set_pwm(msg->m_Value);
            }
...
void UpdateRegisters() {
    ...
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan0_rpm, Fans::print(PhysicalToolIndex::from_raw(0)).get_actual_rpm());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan0_pwm, Fans::print(PhysicalToolIndex::from_raw(0)).get_pwm());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan0_state, Fans::print(PhysicalToolIndex::from_raw(0)).get_state());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan0_is_rpm_ok, Fans::print(PhysicalToolIndex::from_raw(0)).get_rpm_is_ok());

    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan1_rpm, Fans::heat_break(PhysicalToolIndex::from_raw(0)).get_actual_rpm());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan1_pwm, Fans::heat_break(PhysicalToolIndex::from_raw(0)).get_pwm());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan1_state, Fans::heat_break(PhysicalToolIndex::from_raw(0)).get_state());
    ModbusRegisters::SetRegValue(ModbusRegisters::SystemInputRegister::fan1_is_rpm_ok, Fans::heat_break(PhysicalToolIndex::from_raw(0)).get_rpm_is_ok());
