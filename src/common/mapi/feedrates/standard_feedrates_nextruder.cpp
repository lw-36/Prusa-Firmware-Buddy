/// @file standard_feedrates_nextruder.cpp
...
static constexpr EnumArray<Extruder, feedRate_t, Extruder::_count> base_e_feedrate {
    ...
    { Extruder::deretract, 25.0f },
    { Extruder::filament_unload, 25.0f },
    { Extruder::filament_slow_load, 6.0f },
    { Extruder::filament_fast_load, 25.0f },
