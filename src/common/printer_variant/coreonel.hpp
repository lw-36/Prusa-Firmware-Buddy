...
static_assert(HAS_15GT_BELTS(), "CoreOne L printer_variant requires HAS_15GT_BELTS");
static_assert(HAS_CHAMBER_VENTS(), "CoreOne L printer_variant requires HAS_CHAMBER_VENTS");
static_assert(HAS_INDX() || HAS_NOZZLE_CLEANER_LITE(), "non-INDX CoreOne L printer_variant requires HAS_NOZZLE_CLEANER_LITE");
...
static constexpr PrinterVariant printer_variant_after_factory_reset = PrinterVariant::plus;
...
static constexpr EnumArray<PrinterVariant, const char *, PrinterVariant::_cnt> printer_variant_names {
    { PrinterVariant::base, "CORE One L" },
    { PrinterVariant::plus, "CORE One L+" },
};
