...
static_assert(aggregate_arity<Features>() == 3 + HAS_NOZZLE_CLEANER_LITE(), "Revise from_config_store/apply_to_config_store and variant_features");

Features Features::from_config_store() {
    auto &store = config_store();
    return {
        .ejg2 = store.ejg2_installed.get(),
...
constexpr EnumArray<PrinterVariant, Features, PrinterVariant::_cnt> variant_features {
    { PrinterVariant::base, {} },
    { PrinterVariant::plus, { .auto_vent = true } },
    { PrinterVariant::plus_gen2, {
                                     .ejg2 = true,
                                     .belts_15gt = true,
                                     .auto_vent = true,
#if HAS_NOZZLE_CLEANER_LITE()
